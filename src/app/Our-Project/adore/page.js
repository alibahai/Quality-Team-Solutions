...
export default function Adore() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      Adore is a commercial brand that captures modern elegance through soft tones, fluid forms, and balanced lighting. The space feels intimate yet sophisticated — designed to evoke warmth and connection. Every element, from curated materials to subtle detailing, reflects the brand’s essence of effortless beauty and refined simplicity. The result is a timeless environment where design and emotion coexist in harmony.
        </p>
      </div>
