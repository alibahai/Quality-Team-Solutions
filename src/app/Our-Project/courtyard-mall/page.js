    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Courtyard Mall

        </h2>
        <p className="text-gray-700 leading-relaxed">
          Courtyard Mall is a commercial destination that merges open-air leisure with contemporary retail design.
           The layout centers around a landscaped courtyard, creating natural light, visual openness, and a sense of calm amid activity. 
           Each retail unit frames views toward communal spaces, encouraging movement and interaction.
           The result is an inviting environment where architecture, nature, and commerce come together in perfect balance.
        </p>
      </div>
