  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        ...
        FitnGlam is a commercial brand that blends contemporary elegance with an energetic retail identity. 
  The design emphasizes movement, light, and contrast—creating a dynamic environment that celebrates 
  confidence and style. Every spatial element, from lighting to material choice, reinforces a sense 
  of luxury and vitality, making FitnGlam both inviting and aspirational.
        </p>
      </div>
