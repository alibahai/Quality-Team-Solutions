    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Maliha Road 

        </h2>
        <p className="text-gray-700 leading-relaxed">
        Maliha Road is a residential project that emphasizes comfort, privacy, and contemporary living. The design focuses on clean architectural lines, natural light, and thoughtful spatial organization to create a serene home environment. Soft landscapes, warm materials, and balanced proportions enhance the sense of community while maintaining individuality. The result is a calm, cohesive residential development that reflects modern lifestyle values with timeless appeal.
        </p>
      </div>
