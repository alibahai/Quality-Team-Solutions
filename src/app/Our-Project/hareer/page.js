...
export default function Hareer() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        ...
        Hareer blends sophistication with commercial clarity a space where elegance meets utility.
        The design embraces clean geometry, warm tones, and strategic
        lighting that draws attention to key retail zones without overwhelming the senses.
        </p>
      </div>
