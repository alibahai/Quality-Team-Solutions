    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Barsha Mall
        </h2>
        <p className="text-gray-700 leading-relaxed">
          Barsha Mall is a  development that blends modern retail energy with spatial sophistication. The design emphasizes openness, clarity, and natural light, creating a vibrant yet comfortable shopping atmosphere. Distinct zones are carefully planned to enhance visibility, flow, and engagement, offering visitors a seamless retail experience. 
          The result is a dynamic environment that reflects the evolving spirit of urban commerce.
        </p>
      </div>
