    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Jumeirah Road
        </h2>
        <p className="text-gray-700 leading-relaxed">
         Jumeirah Road is a  development that captures the vibrant character of
          urban Dubai through contemporary design and coastal influence. The project integrates
           sleek facades, open storefronts, and shaded walkways to create a comfortable pedestrian
            experience. With its blend of retail, dining, and leisure, the space reflects the dynamic 
            rhythm of city life while maintaining a refined, modern aesthetic. 
         The result is an inviting streetscape that celebrates movement, community, and style.
        </p>
      </div>
