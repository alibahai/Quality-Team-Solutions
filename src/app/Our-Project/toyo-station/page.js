    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Toyo Station
        </h2>
        <p className="text-gray-700 leading-relaxed">
         Toyo Station is a commercial toy shop designed to capture imagination and joy through vibrant colors and engaging spatial design. The layout encourages exploration, blending playfulness with organization to create a seamless shopping experience for all ages. Bright lighting, tactile displays, and cheerful branding transform the space into a world of wonder. The result is a lively retail environment where creativity meets commerce.
        </p>
      </div>
