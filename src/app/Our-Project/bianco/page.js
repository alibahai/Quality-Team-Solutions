  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        ...
        Atlantas Water Park Bianco is a commercial leisure brand that combines excitement with refined design. The space merges bright aquatic themes with sleek architectural detailing, creating an environment that feels both vibrant and elevated. Natural light, open sightlines, and fluid spatial planning enhance the sense of movement and energy. The result is a refreshing retreat where recreation meets modern sophistication.
        </p>
      </div>
