  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        ...
        Eyewa is a commercial brand that embodies clarity, precision, and modern retail design. The interiors use clean lines, luminous lighting, and transparent materials to highlight product quality and visual comfort. Each display is thoughtfully composed to enhance the customer’s journey, merging function with aesthetic ease. The result is a space that feels sleek, confident, and effortlessly aligned with Eyewa’s vision of contemporary eyewear culture.
        </p>
      </div>
