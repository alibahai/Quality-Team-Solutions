  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        ...
        A modern fitness space designed for balance and motivation.
        The gym combines open layouts, natural lighting, 
        and minimalist materials to create a focused yet welcoming atmosphere. Every detail 
        from equipment placement to ambient tones 
        encourages movement, clarity, and comfort, turning exercise into a refined daily experience.
        </p>
      </div>
