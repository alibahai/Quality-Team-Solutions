    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Senso Outlet

        </h2>
        <p className="text-gray-700 leading-relaxed">
Senso Outlet is a residential retail concept that blends convenience with community-focused design. Located within a residential setting, it offers everyday essentials in a refined, accessible environment. The design emphasizes openness, natural textures, and efficient circulation, creating a welcoming destination for residents. The result is a harmonious balance between functionality and comfort — a modern outlet that complements neighborhood living.    </p>
      </div>
