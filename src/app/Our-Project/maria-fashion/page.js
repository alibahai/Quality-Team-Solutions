    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Maria Fashion

        </h2>
        <p className="text-gray-700 leading-relaxed">
Maria Fashion is a commercial clothing brand that celebrates elegance, femininity, and modern design. The space blends soft palettes, graceful lighting, and fluid forms to highlight the textures and craftsmanship of each collection. Thoughtful circulation and minimal detailing ensure focus remains on the garments, creating a refined atmosphere of sophistication and style. The result is a boutique experience that feels timeless, expressive, and effortlessly luxurious.       </p>
      </div>
