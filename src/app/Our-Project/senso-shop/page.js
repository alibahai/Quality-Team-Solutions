    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Senso Shop

        </h2>
        <p className="text-gray-700 leading-relaxed">
Senso Shop is a commercial brand that reflects contemporary simplicity and refined retail aesthetics. The design emphasizes clean geometry, soft illumination, and a neutral material palette to create a calm and inviting atmosphere. Each display is curated with precision, allowing products to stand out through balance and clarity. The result is a sophisticated shopping experience that embodies the brand’s modern, minimalist identity.   </p>
      </div>
