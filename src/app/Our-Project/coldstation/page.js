    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of ColdStation
        </h2>
        <p className="text-gray-700 leading-relaxed">
         ColdStation Cart is a commercial brand concept designed for mobility and freshness.
          The cart embodies clean lines, stainless finishes, and practical form — creating a 
          compact yet striking retail presence. Its design highlights efficiency and hygiene 
          while maintaining visual appeal through thoughtful detailing. The result is a modern,
           on-the-go experience that merges function, freshness, and brand identity seamlessly. 
                  </p>
      </div>
