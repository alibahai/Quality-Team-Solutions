    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Sufoh Villa
        </h2>
        <p className="text-gray-700 leading-relaxed">
          Gallery of Sufoh Villa offers a unique blend of modern elegance and
          timeless charm, making it an ideal showcase of architectural beauty.
          Its spacious interiors and artistic design create a serene environment
          that inspires creativity and relaxation. The villa’s gallery stands
          out as a cultural hub, highlighting art, heritage, and refined living
          under one roof.
        </p>
      </div>
