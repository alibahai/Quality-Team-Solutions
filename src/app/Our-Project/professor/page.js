    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Professor
        </h2>
        <p className="text-gray-700 leading-relaxed">
       Professor channels confidence and precision through bold contrasts, strong geometry,
       and a distinctly modern edge. The environment celebrates structure and clarity 
       clean lines, high-impact lighting, and an efficient plan that keeps focus on the merchandise. Every design element supports the brand’s professional, performance-driven persona. The result is a space that feels smart, assertive, and effortlessly functional 
       the physical embodiment of a contemporary commercial brand built on authority and style.
        </p>
      </div>
