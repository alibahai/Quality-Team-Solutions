    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Senso City

        </h2>
        <p className="text-gray-700 leading-relaxed">
Senso City is a residential walking district designed to enhance community living through open, pedestrian-friendly streets. The layout encourages interaction and movement, weaving green corridors, shaded walkways, and social nodes into the urban fabric. Warm materials and human-scale design create comfort and familiarity, turning everyday routes into shared experiences. The result is a lively, walkable neighborhood that connects people, nature, and modern residential life.      </p>
      </div>
