    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Turkish Icecream
        </h2>
        <p className="text-gray-700 leading-relaxed">
         Turkish Ice Cream is a commercial brand that blends tradition with playful performance. The space captures the charm of street-side theatrics through vibrant colors, tactile materials, and interactive serving counters. The design balances cultural authenticity with modern retail sensibility, creating an atmosphere that feels lively, engaging, and irresistibly memorable.
        </p>
      </div>
