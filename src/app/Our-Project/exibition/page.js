...
export default function Fitnglam() {
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Exibition

        </h2>
        <p className="text-gray-700 leading-relaxed">
The Exhibition space is a commercial showcase designed to highlight creativity, innovation, and brand expression. The layout emphasizes openness and visual flow, allowing visitors to engage seamlessly with displays and installations. Through the use of neutral tones, adaptive lighting, and flexible spatial arrangements, the design accommodates diverse exhibits while maintaining a cohesive aesthetic. The result is an environment that transforms presentation into experience — elegant, dynamic, and immersive.         </p>
      </div>
