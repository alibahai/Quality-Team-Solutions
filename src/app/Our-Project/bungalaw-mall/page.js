    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Bungalaw Mall
        </h2>
        <p className="text-gray-700 leading-relaxed">
          Bungalow Mall is a community-focused commercial hub designed within a residential setting.
           Its architecture harmonizes retail vibrancy with neighborhood calm, offering a comfortable and 
           convenient shopping experience close to home. The design integrates soft landscaping, natural light,
            and pedestrian-friendly pathways, fostering a sense of connection and belonging.
           The result is a refined environment where commerce and community coexist seamlessly.
        </p>
      </div>
