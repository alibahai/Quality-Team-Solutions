    ...
    <section className="w-full overflow-hidden">
      ...
      <div className="relative w-screen left-1/2 right-1/2 -mx-[50vw]">
        <div
          ...
          onMouseLeave={() => {
            // Only resume if no mobile card is active
        ...
        >
          ...
          >
            {doubled.map((item, i) => {
              // Desktop = hover; Mobile = tapped/open index
              ...
              // Click/tap behavior (mobile only)
              const handleClick = () => {
              ...
              return (
                ...
                >
                  ...
                  {/* Overlay: description panel
                      ...
                      - Mobile: only when tapped (active) */}
                  <div
                    className={[
                  ...
                  >
                    <div className="text-white drop-shadow-md text-center md:text-left">
                      {/* Title in overlay:
                          - Mobile expanded: smaller + clamp-2 for long titles
                  ...
                  {/* Bottom title (default view):
                      - Visible when NOT active
                      - On mobile, this is the only thing shown until tapped */}
                  <div
                    className={[
